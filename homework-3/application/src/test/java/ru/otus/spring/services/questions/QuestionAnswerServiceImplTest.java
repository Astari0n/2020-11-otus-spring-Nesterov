...
public class QuestionAnswerServiceImplTest {
    ...
    public void shouldThrowInteractionExceptionWhenQuestionIsNull() {
        final QuestionAnswerServiceImpl service = BDDMockito.mock(QuestionAnswerServiceImpl.class, BDDMockito.CALLS_REAL_METHODS);
    ...
    public void shouldThrowInteractionExceptionIfIOServiceThrownIOServiceException() throws IOServiceException {
        ...
        final QuestionAnswerServiceImpl service = new QuestionAnswerServiceImpl(ioService, localizationService);
